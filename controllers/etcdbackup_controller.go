...
//+kubebuilder:rbac:groups=etcd.yj.io,resources=etcdbackups,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=etcd.yj.io,resources=etcdbackups/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=etcd.yj.io,resources=etcdbackups/finalizers,verbs=update
